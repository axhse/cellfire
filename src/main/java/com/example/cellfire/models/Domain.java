...
public final class Domain {
    ...
    public final static class Settings {
         ...
         */
        public static final double GRID_SIZE = EARTH_CIRCUMFERENCE / GRID_SCALE;
        /**
         * Cell size for both latitude and longitude in degrees.
         */
        public static final double CELL_SIZE = 1.0 / GRID_SCALE_FACTOR;
